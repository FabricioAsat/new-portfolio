	...
	return (
		<article className="flex flex-col gap-y-5 px-4 animate-opacityAnimation">
			<span className="flex flex-col items-center text-center my-2 sm:my-4">
				<h1 className="longSize text-orange-500 font-bold">Hello again!</h1>
			...
			{/* -------------------------------------------------------- */}
			<section>
				<h2 className="mediumSize text-center font-bold mb-2 text-orange-500">My story</h2>
				<p className="tinySize italic">
					Well, my name is <b className="text-indigo-500">Fabricio Daniel Asat</b>, I was born on
					...
					<b className="text-indigo-500">beginning in programming</b>. I went through many
					programming languages, such as{" "}
					<b className="text-indigo-500">C - C++, Python, Java, Golang</b> and finally 1 year ago I
					...
					<b className="text-indigo-500">Frontend</b> (because it's easier in my opinion) using{" "}
			...
			<section className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-5 w-full justify-items-center items-center lg:items-start pt-2 md:py-4 pl-4">
				...
				<span className="col-span-2">
					<h2 className="mediumSize text-center font-bold mb-2 text-orange-500">
					...
					<ol className="tinySize italic list-disc marker:text-orange-500 w-full text-start">
						<li>
							I <b className="text-indigo-500">love programming</b> and if I do it while listening
							to LOFI I lose track of time.{" "}
						</li>
						<li>
							I like to spend my weekends programming in the morning/afternoon and{" "}
							<b className="text-indigo-500">playing video games</b> at night.
						</li>
						<li>
							I like to implement new features to my programs or create new projects using{" "}
							<b className="text-indigo-500">new technologies</b>.
						</li>
						<li>
							When I get stuck while programming, either because of bugs or other things, I like to
							<b className="text-indigo-500"> go outside and breathe fresh air</b> for a while.{" "}
						</li>
						<li>
							I love <b className="text-indigo-500">animals</b>, I have some very cute pets that I
			...
			<section className="flex flex-col items-center">
				<span className="mb-2 text-center">
					<h2 className="mediumSize font-bold text-orange-500">Explaining more about me</h2>
					<p className="tinySize italic">
				...
				<aside className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-5 w-full justify-items-center items-center lg:items-start pt-2 md:py-4 pl-4">
					...
					<span className="flex flex-col col-span-2">
						<h3 className="lowMediumSize font-bold text-orange-500 text-center">
						...
						<ol className="tinySize italic list-disc marker:text-orange-500 w-full text-start">
							...
							<li>
								...
								<b className="text-indigo-500">new frameworks and methods</b>.
							</li>
							<li>
								Start backend development with <b className="text-green-600">Node.js</b> while I
							...
							<li>
								Develop new projects and/or <b className="text-indigo-500">lead</b> working groups.{" "}
							</li>
						</ol>
					</span>
				</aside>
			...
			<section className="flex flex-col gap-y-5 items-center">
				<span className="text-center">
					<h2 className="mediumSize font-bold text-orange-500">How do I work?</h2>
				...
				<ol className="tinySize italic list-disc marker:text-orange-500 w-full max-w-3xl text-start pl-4">
					<li>
						I start by <b className="text-indigo-500">thinking</b> about what I'm going to do.
					</li>
					<li>
						Once it's done, I think about the <b className="text-indigo-500">design</b>, do a quick
						sketch in my head or maybe on paper.
					</li>
					<li>
						I decide what <b className="text-indigo-500">technologies</b> I'm going to use.{" "}
					</li>
					<li>
						I start coding. I put in the <b className="text-indigo-500">design</b>, the <b>style</b>
						, the <b>logic</b>, etc.
					</li>
					<li>
						Once the prototype is done, I upload it and seek{" "}
						<b className="text-indigo-500">feedback</b> from a third party (my brother).
					</li>
					<li>
						I <b className="text-indigo-500">update</b> the small bugs,{" "}
						<b className="text-indigo-500">optimize</b> the code,{" "}
						<b className="text-indigo-500">improve</b> the styles,{" "}
						<b className="text-indigo-500">remove</b> the junk code and publish it.
					</li>
					<b></b>
				</ol>
			</section>
