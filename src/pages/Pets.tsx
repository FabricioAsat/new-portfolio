	...
	return (
		<article className="flex flex-col gap-y-8 animate-opacityAnimation h-full">
			<span className="flex flex-col items-center text-center mt-2 sm:mt-4 mb-6">
				<h1 className="longSize font-bold">I'll show them to you!</h1>
				...
				<nav
					className={`flex gap-x-6 w-full max-w-md lowMediumSize mt-4 px-1 ${
			...
			{wantView && (
				<div className="relative w-full max-w-lg mx-auto">
					<nav className="relative flex justify-center gap-x-14 items-center z-40 w-full mb-2">
						<button
							className="font-bold bg-gray-500/20 text-darkDark px-3 py-2 rounded-lg my-2 hover:bg-gray-500/50 hover:text-darkLight transition-all duration-200"
							onClick={prevImage}>
							{"◀ "}Previous
						</button>
						<button
