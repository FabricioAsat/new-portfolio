			...
			{wantView && (
				<div className="relative w-full max-w-lg mx-auto">
					<nav className="relative flex justify-center gap-x-14 items-center z-40 w-full mb-2">
						<button
							className="font-bold bg-gray-500/20 text-orange-500/75 px-3 py-2 rounded-lg my-2 hover:bg-gray-500/50 hover:text-orange-500 transition-all duration-200"
							onClick={prevImage}>
							{"◀ "}Previous
						</button>
						<button
